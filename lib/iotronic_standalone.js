        ...
        if (IoTronic_IP != undefined) {
            ...
            rest.get('/', function (req, res) {
                ...
                if (https_enable == "true"){
                    res.status(200).send("<center> Welcome in Iotronic-standalone! <br><br><br> <a href='https://" + IoTronic_IP + "/iotronic-api-docs/'>Please visit API documentation</a> </center>");

                }else{
                    res.status(200).send("<center> Welcome in Iotronic-standalone! <br><br><br> <a href='http://" + IoTronic_IP + "/iotronic-api-docs/'>Please visit API documentation</a> </center>");
