        ...
        if (IPLocal != undefined) {
            ...
            rest.get('/', function (req, res) {
                ...
                if (https_enable == "true"){
                    res.status(200).send("<center> Welcome in Iotronic-standalone! <br><br><br> <a href='https://" + IPLocal + ":" + https_port + "/v1/iotronic-api-docs/'>Please visit API documentation</a> </center>");
