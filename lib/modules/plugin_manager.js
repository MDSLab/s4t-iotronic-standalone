...
plugin_utils = function (session, rest) {
                                ...
                                (function (i) {
                                    ...
                                    board_utility.checkBoardAvailable(board_id, res, function (available) {
                                        ...
                                        if (available.result == "SUCCESS") {
                                            ...
                                            plugin_utils.injectPlugin(board_id, plugin, onboot, force, false);
                                    ...
                                    if (i === (boards_list.length - 1)) {
                                        ...
                                        response.result = "SUCCESS";
                                        response.message = "Injecting plugin "+plugin+" on boards of the project '" + project + "'!";
     ...
     *        schema:
     *        type: string
     *        description: "The IoTronic plugin ID or NAME"
     *      - in: path
     *        name: project
     *        required: true
     *        schema:
                                ...
                                (function (i) {
                                    ...
                                    board_utility.checkBoardAvailable(board_id, res, function (available) {
                                        ...
                                        if (available.result == "SUCCESS") {
                                            ...
                                            plugin_utils.managePlugins(board_id, plugin, parameters, operation, false);
                                            //logger.info("[PLUGIN] --> Plugin operation on board "+ board_id);
                                    ...
                                    if (i === (boards_list.length - 1)) {
                                        ...
                                        response.result = "SUCCESS";
                                        response.message = "Executing plugin operation on boards of the project '" + project + "'!";
                                        logger.info("[PROJECT] --> " + response.message);
                                        res.status(200).send(response);
                        ...
                        (function (i) {
                            ...
                            board_utility.checkBoardAvailable(board_id, res, function (available) {
                                ...
                                if (available.result == "SUCCESS") {
                                    ...
                                    plugin_utils.removePlugin(board_id, plugin, false);
                            ...
                            if (i === (boards_list.length - 1)) {
                                ...
                                response.result = "SUCCESS";
                                response.message = "Removing plugin "+plugin+" from boards of the project '" + project + "'!";
                                logger.info("[PROJECT] --> " + response.message);
                                res.status(200).send(response);
    ...
    rest.patch('/v1/plugins/:plugin', function (req, res) {
        ...
        //var ApiRequired = {"name":name, "category":category, "defaults":defaults, "code":code, "version":version, "type":type_id, "tag":tag_id};
        ...
        board_utility.checkRequired(ApiRequired, function (check){
            ...
            if(check.result == "ERROR"){
                ...
                //plugin_utils.updatePlugin(plugin, name, category, defaults, code, description, version, tag_id, type_id, res);
...
//plugin_utils.prototype.updatePlugin = function (plugin, name, category, defaults, code, description, version, tag_id, type_id, res) {
                                                ...
                                                function (rpc_response) {
                                                    ...
                                                    if (rpc_response.result == "ERROR") {
                                                        ...
                                                        if(res != false){
                                                            ...
                                                            logger.info("[PLUGIN] --> Start '" + plugin_name + "' plugin result on board '"+board+"': " + response.message);
                                                        }
                                        ...
                                        session_wamp.call('s4t.'+ board + '.plugin.call', [plugin_name, pluginjson, plugin_checksum], {}, {receive_progress: true}).then(
                                            ...
                                            function (rpc_response) {
                                                ...
                                                if (rpc_response.result == "ERROR") {
                                                    ...
                                                    if(res != false){
                                                        ...
                                                        logger.info("[PLUGIN] --> Executing error for '" + plugin_name + "' plugin result on board '"+board+"': " + response.message);
                                                    }
                                                    ...
                                                    if(res != false){
                                                        ...
                                                        logger.info("[PLUGIN] --> Executing result for '" + plugin_name + "' plugin result on board '"+board+"': " + response.message);
                                                    }
                                            ...
                                            function (error) {
                                                ...
                                                if(res != false){
                                                    ...
                                                    logger.info("[PLUGIN] --> Executing RPC error for '" + plugin_name + "' plugin result on board '"+board+"': " + response.message);
                                                }
                                ...
                                function (rpc_response) {
                                    ...
                                    if (rpc_response.result == "ERROR") {
                                        ...
                                        if(res != false){
                                            ...
                                            logger.info("[PLUGIN] --> Stop '" + plugin_name + "' plugin result on board '"+board+"': " + response.message);
                                        }
                                ...
                                function (rpc_response) {
                                    ...
                                    if (rpc_response.result == "ERROR") {
                                        ...
                                        if(res != false){
                                            ...
                                            logger.info("[PLUGIN] --> Restart plugin result on board '"+board+"': " + response.message);
                                        }
                    ...
                    if (data.result == "ERROR") {
                        ...
                        if(data.message.length == 0){
                            ...
                            if(res != false){
                                ...
                                response.message = "Plugin '" + pluginName + "' already removed from "+board+" board!";
                                response.result = "WARNING";
                                logger.warn("[PLUGIN] --> " + response.message);
                                        ...
                                        db.deleteInjectedPlugin(board, pluginId, function (data_p) {
                                            ...
                                            if (data_p.result == "ERROR") {
                                                ...
                                                if(res != false){
                                                    ...
                                                    response.message = "Plugin '" + pluginName + "' successfully removed from "+board+" board!";
                                                    response.result = "WARNING";
                                                    logger.warn("[PLUGIN] --> " + response.message);
