                        ...
                        if (data.result == "ERROR") {
                            ...
                            if (data.message[0] === undefined) {
                                ...
                                if (pluginTag == "released") {
                                    ...
                                    var subject = "/projects/"+project+"/plugins/"+plugin;
                ...
                board_utility.checkRequired(ApiRequired, function (check){
                    ...
                    if(check.result == "ERROR"){
                        ...
                        if(operation != "run" && operation != "kill" && operation != "call"  && operation != "restart" ){
                            ...
                            plugin_utils.managePlugins(board, null, [plugin, parameters, operation, res]);
        ...
        board_utility.checkRequired(ApiRequired, function (check){
            ...
            if(check.result == "ERROR"){
                ...
                if(operation != "run" && operation != "kill" && operation != "call"  && operation != "restart" ){
                    ...
                    request_utils.batchRequest(project, subject, res, plugin_utils.managePlugins, [plugin, parameters, operation, false]);
