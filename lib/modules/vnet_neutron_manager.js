...
var socatNetwork = nconf.get('config:modules:vnets_manager:socat:ip');
var basePort = nconf.get('config:modules:vnets_manager:socat:server:port');
...
var neutron_utils = require('./vnet_neutron_utils');
