                                ...
                                for (var i = 0; i < boards_list.length; i++) {
                                    ...
                                    (function (i) {
                                        ...
                                        board_utility.checkBoardAvailable(board_id, res, function (available) {
                                            ...
                                            if (available.result == "SUCCESS") {
                                                ...
                                                setTimeout(function(){
                                                    ...
                                                    services_utils.manageService(board_id, service, service_action, false);
                                        ...
                                        if (i === (boards_list.length - 1)) {
                                            ...
                                            response.result = "SUCCESS";
                                            response.message = "Performing "+ service_action +" action for service "+service+" on boards of the project '" + project + "'!";
