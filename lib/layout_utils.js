...
layout_utils = function (session, rest) {
    ...
    rest.delete('/v1/layouts/:layout', function (req, res) {
        ...
        logger.debug("[API] - Delete board layout - " + Object.keys( req.route.methods ) + " - " + req.route.path);
    ...
    rest.patch('/v1/layouts/:layout', function (req, res) {
        ...
        logger.debug("[API] - Update board layout - " + Object.keys( req.route.methods ) + " - " + req.route.path);
    ...
    rest.get('/v1/layouts/:layout', function (req, res) {
        ...
        logger.debug("[API] - Get IoTronic board layout details - " + Object.keys( req.route.methods ) + " - " + req.route.path);
