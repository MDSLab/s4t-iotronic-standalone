                            ...
                            try {
                                ...
                                if (req.body.extra != undefined) {
                                    ...
                                    if(isJSON){
                                        ...
                                        db.regBoard(board_id, board_label, latitude, longitude, altitude, net_enabled, sensorslist, type, description, project_id, user_id, mobile, position_refr_time, notify, notify_rate, notify_retry, function (db_result) {
    ...
    rest.patch('/v1/boards/:board', function (req, res) {
        ...
        checkBoardAvailable(board, res, function (available) {
            ...
            if (available.result != "ERROR") {
                ...
                db.updateBoard(board, board_label, latitude, longitude, altitude, net_enabled, sensorslist, type, description, project_id, user_id, mobile, position_refr_time, notify, notify_rate, notify_retry, function (db_result) {
