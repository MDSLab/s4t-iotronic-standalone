        ...
        checkRestInputs(req, function (check){
            ...
            if(check.result == "ERROR"){
                ...
                var APIparamsList= {"board_label":board_label, "board_id":board_id, "latitude":latitude, "longitude":longitude, "altitude":altitude,
                    "net_enabled":net_enabled, "type":type, "user_id":user_id, "project_id":project_id, "mobile":mobile, "position_refr_time":position_refr_time};
                            ...
                            try {
                                ...
                                if (req.body.extra != undefined) {
                                    ...
                                    if(isJSON){
                                        ...
                                        db.regBoard(board_id, board_label, latitude, longitude, altitude, net_enabled, sensorslist, type, description, project_id, user_id, mobile, position_refr_time, function (db_result) {
    ...
    rest.patch('/v1/boards/:board', function (req, res) {
        ...
        checkBoardAvailable(board, res, function (available) {
            ...
            if (available.result != "ERROR") {
                ...
                db.updateBoard(board, board_label, latitude, longitude, altitude, net_enabled, sensorslist, type, description, project_id, user_id, mobile, position_refr_time, function (db_result) {
