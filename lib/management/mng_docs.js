...
var exposeApiDocumentation  = function (rest, swaggerSpec){
    ...
    rest.get('/v1/', function (req, res) {
        ...
        if (https_enable == "true"){
            res.status(200).redirect("https://" + IPLocal + ":" + https_port + "/v1/iotronic-api-docs/");
        }else{
            res.status(200).redirect("http://" + IPLocal + ":" + restPort + "/v1/iotronic-api-docs/");
        }
    ...
    */
    ...
    if (https_enable == "true"){
        logger.info("[API-DOCS] - Documentation available at https://"+IPLocal+":"+https_port+"/v1/iotronic-api-docs");
    }else{
        logger.info("[API-DOCS] - Documentation available at http://"+IPLocal+":"+restPort+"/v1/iotronic-api-docs");
    }
