...
db_utils.prototype.BoardInfo = function (board, callback) {
    ...
    connection.query("SELECT " +
        ...
        "WHERE boards.board_id = '" + board + "' AND coordinates.board_id = boards.board_id AND boards.type = layouts.id_layout AND boards.projects_id = projects.uuid AND boards.users_id = users.uuid", function (err_info, result_info) {
...
db_utils.prototype.regBoard = function (board, board_label, latitude, longitude, altitude, net_enabled, sensorsList, type, description, extra, project_id, user_id, mobile, position_refr_time, notify, notify_rate, notify_retry, callback) {
        ...
        if (result.length == 0) {
            ...
            connection.beginTransaction(function(err) {
                ...
                if (err) {
                    ...
                    connection.query("INSERT INTO boards (board_id, label, session_id, status, net_enabled, type, description, extra, projects_id, users_id, mobile, position_refresh_time, " +
...
db_utils.prototype.updateBoard = function (board, board_label, latitude, longitude, altitude, net_enabled, sensorsList, type, description, extra, project_id, user_id, mobile,
...
db_utils.prototype.getLayoutByBoardId = function (board_id, callback) {
    ...
    connection.query("SELECT layouts.id_layout, layouts.model, layouts.manufacturer, layouts.image FROM layouts, boards WHERE boards.type = layouts.id_layout AND boards.board_id = '" + board_id + "'", function (err, result) {
