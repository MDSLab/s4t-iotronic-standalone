...
db_utils.prototype.getPlugin = function (plugin, callback) {
    ...
    if (isNaN(plugin))
        var query = "SELECT plugins.id, plugins.name, plugins.description, plugins.category, plugins.version, plugins.code, plugins.defaults, plugins.checksum, plugin_tags.tag, plugin_types.type " +
