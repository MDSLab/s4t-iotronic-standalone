...
layout_utils = function (session, rest) {
     ...
     *                          image:
     *                              type: string
     *                              description: "OS image version used by device: 'Raspbian', 'LEDE'"
     *                          layout:
     *                              type: string
     *                              description: "Iotronic device layout"
     *                          distro:
     *                              type: string
     *                              description: "OS distribution: 'debian', 'openwrt'"
     *       403:
    ...
    rest.post('/v1/layouts/', function (req, res) {
        ...
        var ApiRequired= {"model":model, "manufacturer":manufacturer, "layout":layout, "distro":distro};
        ...
        board_utility.checkRequired(ApiRequired, function (check){
            ...
            if(check.result == "ERROR"){
                ...
                layout_utils.prototype.createLayout(model, manufacturer, image, layout, distro, res);
    ...
    rest.patch('/v1/layouts/:layout', function (req, res) {
        ...
        board_utility.checkRequired(ApiRequired, function (check){
            ...
            if(check.result == "ERROR"){
                ...
                layout_utils.prototype.updateLayout(layout_id, model, manufacturer, image, layout, distro, res);
...
layout_utils.prototype.createLayout = function (model, manufacturer, image, layout, distro, res) {
    ...
    logger.info("[LAYOUT] --> distro " + distro);
    ...
    db.createLayout(model, manufacturer, image, layout, distro, function (result_db) {
...
layout_utils.prototype.updateLayout = function (layout_id, model, manufacturer, image, layout, distro, res) {
    ...
    db.getLayoutById(layout_id, function (data) {
        ...
        if (data.result == "ERROR") {
            ...
            if (data.message[0] === undefined) {
                ...
                db.updateLayoutById(layout_id, model, manufacturer, image, layout, distro, function (result_db) {
