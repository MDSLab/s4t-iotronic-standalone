...
user_utils.prototype.createUser = function (username, password, email, f_name, l_name, res) {
    ...
    bcrypt.hash(password, 5, function( err, bcryptedPassword) {
        ...
        logger.debug("--> encrypted pw: " + bcryptedPassword);
        ...
        if (err) {
            ...
            db.createUser(user_id, username, bcryptedPassword, email, f_name, l_name, function (result_db) {
    ...
    db.getUser(user_id, function (data) {
        ...
        if (data.result == "ERROR") {
            ...
            if (data.message[0] === undefined) {
                ...
                db.updateUser(user_id, username, password, email, f_name, l_name, function (result_db) {
