...
db_utils.prototype.getBoardInfo = function(board, callback){
	...
	connection.query("SELECT label, altitude, longitude, latitude, net_enabled FROM boards_connected, user_boards WHERE boards_connected.board_code = '" + board + "' AND boards_connected.board_code = user_boards.board_code", function(err_info, result_info){
