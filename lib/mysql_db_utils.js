...
db_utils.prototype.regBoard = function (board, board_label, latitude, longitude, altitude, net_enabled, sensorsList, type, description, project_id, user_id, mobile, position_refr_time, notify, notify_rate, notify_retry, callback) {
        ...
        if (result.length == 0) {
            ...
            connection.beginTransaction(function(err) {
                ...
                if (err) {
                    ...
                    connection.query("INSERT INTO boards (board_code, label, session_id, status, net_enabled, type, description, projects_id, users_id, mobile, position_refresh_time, notify, notify_rate, notify_retry) " +
                        "VALUES ('" + board + "', " +
                        "'" + board_label + "'," +
                        "'null'," +
                        "'D', " +
...
db_utils.prototype.updateBoard = function (board, board_label, latitude, longitude, altitude, net_enabled, sensorList, type, description, project_id, user_id, mobile, position_refr_time, notify, notify_rate, notify_retry, callback) {
            ...
            connection.beginTransaction(function(err) {
                ...
                if (err) {
                    ...
                    connection.query("UPDATE boards, coordinates SET boards.label='" + board_label + "', boards.type='" + type + "', boards.description='" + description + "', boards.projects_id='" + project_id + "', " +
                        ...
                        "boards.users_id='" + user_id + "', boards.mobile='" + mobile + "', boards.net_enabled='" + net_enabled + "', boards.position_refresh_time='" + position_refr_time + "', notify='"+notify+"', notify_rate='"+notify_rate+"', notify_retry='"+notify_retry+"' " +
