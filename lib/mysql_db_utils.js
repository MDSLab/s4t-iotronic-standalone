...
db_utils.prototype.getService = function (serviceName, callback) {
    conn();
    var response = {
        message: '',
        result: ''
...
db_utils.prototype.getBoardServices = function (board_id, callback) {
    ...
    connection.query("SELECT * FROM active_services WHERE board_id = '" + board_id + "'", function (err, result) {
