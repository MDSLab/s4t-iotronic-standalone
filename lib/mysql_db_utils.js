...
db_utils.prototype.BoardInfo = function (board, callback) {
    ...
    connection.query("SELECT boards.board_code, boards.label, boards.reg_time, boards.description, boards.mobile, users.username as user, projects.name as project, layouts.model, layouts.manufacturer, layouts.image, boards.net_enabled, coordinates.altitude, coordinates.longitude, coordinates.latitude " +
...
db_utils.prototype.regBoard = function (board, board_label, latitude, longitude, altitude, net_enabled, sensorsList, type, description, project_id, user_id, mobile, position_refr_time, callback) {
        ...
        if (result.length == 0) {
            ...
            connection.beginTransaction(function(err) {
                ...
                if (err) {
                    ...
                    connection.query("INSERT INTO boards (board_code, label, session_id, status, net_enabled, type, description, projects_id, users_id, mobile, position_refresh_time) " +
                        "VALUES ('" + board + "', " +
                        "'" + board_label + "'," +
                        "'null'," +
                        "'D', " +
...
//Function to register a new board
db_utils.prototype.updateBoard = function (board, board_label, latitude, longitude, altitude, net_enabled, sensorList, type, description, project_id, user_id, mobile, position_refr_time, callback) {
            ...
            connection.beginTransaction(function(err) {
                ...
                if (err) {
                    ...
                    connection.query("UPDATE boards, coordinates SET boards.label='" + board_label + "', boards.type='" + type + "', boards.description='" + description + "', boards.projects_id='" + project_id + "', " +
                        ...
                        "boards.users_id='" + user_id + "', boards.mobile='" + mobile + "', boards.net_enabled='" + net_enabled + "', boards.position_refresh_time='" + position_refr_time + "' " +
...
//OK-DB TO CHECK
//Function to check if a board is registered
...
db_utils.prototype.getBoardPosition = function (board_id, callback) {
    ...
    connection.query("SELECT altitude, longitude, latitude FROM coordinates WHERE coordinates.board_id = '" + board_id + "' ORDER BY timestamp ASC", function (err, result) {
        if (err != null) {
            response.result = "ERROR";
            response.message = err;
            disconn();
...
//           LAYOUTS MANAGEMENT          //
///////////////////////////////////////////
//Function to obtain board layouts list managed by IoTronic
...
//Function to obtain the board layout details
...
//           PROJECTS MANAGEMENT         //
///////////////////////////////////////////
//Function to obtain IoTronic projects list
...
//Function to obtain the IoTronic project details
...
//             USERS MANAGEMENT          //
///////////////////////////////////////////
//Function to obtain projects list
...
//Function to obtain the IoTronic user details
