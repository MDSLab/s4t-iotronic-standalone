...
db_utils.prototype.BoardInfo = function (board, callback) {
    ...
    connection.query("SELECT boards.board_code, boards.label, boards.latest_update, boards.description, boards.mobile, users.username as user, projects.name as project, layouts.id_layout as layout, layouts.model, layouts.manufacturer, layouts.image, boards.net_enabled, coordinates.altitude, coordinates.longitude, coordinates.latitude " +
