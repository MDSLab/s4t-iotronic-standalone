...
vfs_utils = function (session, rest) {
    ...
    rest.get('/v1/nodes/:node/vfs', function (req, res) {
        ...
        logger.debug("[VFS] - Mountpoints list for the node " + node);
        
        db.NodeMountpoints(node, function (data) {
    ...
    //mount VFS in a node
    rest.post('/v1/nodes/:node/vfs/mount', function (req, res) {
    ...
    rest.post('/v1/nodes/:node/vfs/unmount', function (req, res) {
    ...
    //force-mount VFS in a node
    rest.post('/v1/nodes/:node/vfs/force-mount', function (req, res) {
                    ...
                    if(check.result == "ERROR"){
                        ...
                        node_utility.checkRestInputs(req, function (check){
                            ...
                            if(check.result == "ERROR"){
                                ...
                                db.deleteMountpoint(node, path_dst, node_src, path_src, function (check_result) {
