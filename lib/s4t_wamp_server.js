		...
		db.checkBoardConnected(board, function(data){
		  ...
		  if(data.length == 1){
			...
			error:{}
			  ...
			  case 'driver':
			      //http://212.189.207.205:8888/command/?command=driver&drivername=temp_driver&driveroperation=mount&board=14144545
			      //http://212.189.207.205:8888/command/?command=driver&drivername=temp_driver&driveroperation=unmount&board=14144545
			  ...
			  case 'injectdriver':
			      //http://212.189.207.205:8888/command/?command=injectdriver&board=14144545&drivername=temp_driver&autostart=True
			      driver_utils.injectDriver(board, drivername, autostart, res);
			      break	

			  case 'readdriverfile':
			      //http://212.189.207.205:8888/command/?command=readdriverfile&board=14144545&drivername=temp_driver&filename=temperature
			  ...
			  case 'writedriverfile':
			      //http://212.189.207.205:8888/command/?command=writedriverfile&board=14144545&drivername=temp_driver&filename=temperature&filecontent="AAA"
