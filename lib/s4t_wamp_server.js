                                            ...
                                            if (data.result == "ERROR") {
                                                ...
                                                db.getBoardServices(board_id, function (data) {
                                                    ...
                                                    if (data.result == "ERROR") {
                                                        ...
                                                        if(data.message.length == 0)
                                                            logger.info("[SERVICE] - No service to restore for this board!")
                                                        else
                            ...
                            db.changeBoardState(board, 'null', 'D', function (data) {
                                ...
                                if (data.result == "ERROR") {
                                    ...
                                    db.removeAllServices(board, function (response) {
                                        ...
                                        if(response.result == "ERROR")
                                            logger.error("[SERVICE] - Error updating active services status: " +response.message);
                                        else
                                            logger.debug("[SERVICE] - Services status of board " + board + " ("+label+") updated.");
