    ...
    if (IPLocal != undefined) {
        ...
        connection.onopen = function (session, details) {
            ...
            rest.post('/api/users', function(req, res) {
                ...
                logger.info('/api/users -> ',user_id,token,geo);

                res.send(user_id + ' ' + token + ' ' + geo);
            });

            rest.get('/nodes/', function (req, res) {
            ...
            rest.get('/nodes/:board', function(req, res) {
            ...
            rest.post('/nodes/', function(req, res) {

                logger.info("[SYSTEM] - NEW BOARD " + req.body.board_label + " (" + req.body.board + ") REGISTRATION:\n" + JSON.stringify(req.query, null, "\t"));

                db.regBoard(req.body.board, req.body.board_label, req.body.latitude, req.body.longitude, req.body.altitude, req.body.net_enabled, req.body.sensorlist, function (db_result) {
            ...
            rest.patch('/nodes/', function(req, res) {
                ...
                db.updateBoard(req.body.board, req.body.board_label, req.body.latitude, req.body.longitude, req.body.altitude, req.body.net_enabled, req.body.sensorlist, function (db_result) {
                    ...
                    var position = {"altitude": req.body.altitude, "longitude": req.body.longitude, "latitude": req.body.latitude}
            ...
            rest.delete('/nodes/:board', function(req, res) {
