...
s4t_wamp_server.prototype.start = function(restPort, wamp_router_url, wamp_realm){
  ...
  connection.onopen = function (session, details) {
	...
	if(command == "reg-board"){
		...
		db.regBoard(board, board_label, latitude, longitude, altitude, net_enabled, sensorlist, function(result){
		...
		db.updateBoard(board, board_label, latitude, longitude, altitude, net_enabled, sensorlist, function(result){
