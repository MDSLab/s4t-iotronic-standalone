...
plugin_utils.prototype.managePlugins = function(board, pluginname, pluginjson, pluginoperation, res){
    ...
    switch(pluginoperation){
        ...
        case 'run':
            ...
            console.log("RUNNER PLUGIN \""+pluginname+"\" CALLED...");
        ...
        case 'call':
            ...
            console.log("CALL PLUGIN \""+pluginname+"\" CALLED... ");
		...
		if (plugincategory === "sync"){
		    ...
		    //session_wamp.call(board+'.command.rpc.plugin.call_sync', [pluginname, pluginjson], {}, {receive_progress: true}).then(
