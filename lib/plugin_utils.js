...
plugin_utils = function (session, rest) {
    ...
    rest.get('/v1/nodes/:node/plugins', function (req, res) {

        logger.debug("[API] - Node plugins list - " + Object.keys( req.route.methods ) + " - " + req.route.path);
        ...
        logger.debug("[PLUGIN] - Plugins list for the node " + node);

        db.NodePlugins(node, function (data) {
    ...
    //GET plugin details inside a node
    rest.get('/v1/nodes/:node/plugins/:plugin', function (req, res) {

        logger.debug("[API] - Node plugin details - " + Object.keys( req.route.methods ) + " - " + req.route.path);
        ...
        plugin_utils.prototype.getNodePluginDetails(node, pluginname, res);
    ...
    rest.put('/v1/nodes/:node/plugins/:plugin', function (req, res) {
        ...
        node_utility.checkNodeAvailable(node, res, function (available){
            ...
            if(available.result == "SUCCESS"){
                ...
                //var APIparamsList= {"pluginname":pluginname, "autostart":autostart};
    ...
    rest.post('/v1/nodes/:node/plugins/:plugin/action', function (req, res) {
                            ...
                            if(check.result == "ERROR"){
                                ...
                                node_utility.checkRestInputs(req, function (check){
                                    ...
                                    if(check.result == "ERROR"){
                                        ...
                                        logger.debug("[PLUGIN] - Plugin operation on node "+ node +" called.");
    ...
    rest.delete('/v1/nodes/:node/plugins/:plugin', function (req, res) {
...
plugin_utils.prototype.getNodePluginDetails = function (node, pluginname, res) {
    ...
    logger.debug("[PLUGIN] - Plugin "+pluginname+" details on node " + node);
    ...
    db.getPlugin(pluginname, function (data) {
        ...
        if (data.result == "ERROR") {
            ...
            if (data.message[0] === undefined) {
                ...
                db.getInjectedPlugin(pluginId, node, function (data) {
