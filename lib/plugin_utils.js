...
plugin_utils = function (session, rest) {
    ...
    //logger.debug("IP PLUGIN: "+IPLocal);
    ...
    rest.delete('/v1/plugins/:node', function (req, res) {
        ...
        node_utility.checkNodeAvailable(node, res, function (available){
            ...
            if(available == true){
                ...
                plugin_utils.prototype.removePlugin(node, pluginname, res);
...
plugin_utils.prototype.managePlugins = function (board, pluginname, pluginjson, pluginoperation, res) {
    ...
    switch (pluginoperation) {
        ...
        default:
            ...
            var message = "Wrong plugin operation called: " + pluginoperation + " operation not supported!"
