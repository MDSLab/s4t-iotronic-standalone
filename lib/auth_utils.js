        ...
        db.getUserList(function (data) {
            ...
            if (data.result == "ERROR") {
                ...
                if (selected_user.length === 0){
                    ...
                    logger.error("[USER] - Login failed: no user " + req.body.username);
                    ...
                    logger.info("[USER] - Login requester user: " + selected_user.username);
                    ...
                    checkPassword(req.body.password, selected_user.password).then( function (pw_result) {
                        ...
                        if (pw_result.result == "SUCCESS"){
                            ...
                            logger.info("[USER] - User " + selected_user.username + " logged in successfully!");
