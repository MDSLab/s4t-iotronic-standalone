...
driver_utils.prototype.createDriver = function(drivername, driverjson, drivercode, res){
	...
	if (data[0] === undefined){
	      ...
	      try{
		    ...
		    logger.info("[DRIVER] - Creating new driver " + drivername + "...");
	  ...
	  response.result = result_db;
	  res.send("[DRIVER] --> "+JSON.stringify(response));
	  logger.warn(result_db);	  
	...
	if (data[0] === undefined){
	  ...
	  logger.warn(result_db);
		  ...
		  if (data_p[0] === undefined){
		      ...
		      logger.debug("RPC call to write a remote file "+drivername+"["+filename+"] ...");
			  ...
			  function(result){
			      ...
			      res.send(JSON.stringify(response));
			      logger.info("Remote writing file result "+drivername+"["+filename+"] : " + result);
			  ...
			  function (error) {
			      ...
			      res.send(JSON.stringify(response));
			      logger.warn('Writing remote file failed! - Error: '+ JSON.stringify(error));
			  }
	  ...
	  logger.warn(result_db);
		  ...
		  if (data_p[0] === undefined){
			  ...
			  function(result){
			      ...
			      res.send(JSON.stringify(response));
			      logger.info("Remote reading file result "+drivername+"["+filename+"] : " + result);
			  ...
			  function (error) {
			      ...
			      response.result = {"driver":drivername, "file":filename, "response":error_log};
			      res.send(JSON.stringify(response));
			      logger.warn('Reading remote file failed! - Error: '+ JSON.stringify(error));
			  }
...
driver_utils.prototype.destroyDriver = function(drivername, res){
    ...
    logger.info("[DRIVER] - DELETING " + drivername + " driver...");
    //logger.info("[DRIVER] --> Calling destroyDriver with name = " + drivername);
