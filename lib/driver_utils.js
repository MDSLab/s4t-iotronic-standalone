...
driver_utils.prototype.manageDrivers = function(board, drivername, driveroperation, res){
    ...
    switch(driveroperation){
		...
		function(driver_result){
		    ...
		    logger.info("Driver mount result for \""+ drivername +"\": " + JSON.stringify(driver_result.result));
	    ...
	    */
	    ...
	    logger.info("RPC call to unmount driver \""+drivername+"\"...");
		    ...
		    res.send(JSON.stringify(driver_result));
		    logger.info("Driver mount unmount for \""+ drivername +"\": " + JSON.stringify(driver_result.result));
