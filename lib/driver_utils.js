    ...
    db.getDriverId(drivername, function (data) {
        ...
        if (data[0] === undefined) {
            ...
            db.getInjectedDriver(driverId, board, function (data_p) {
                ...
                if (data_p[0] === undefined || data_p[0].state != "mounted") {

                    if (data_p[0].state != "mounted") result_db = "The driver " + drivername + " is not mounted in the board " + board + " !";
                    else if (data_p[0] === undefined) result_db = "The driver " + drivername + " is not injected in the board " + board + " !";
        ...
        if (data[0] === undefined) {
            ...
            db.getInjectedDriver(driverId, board, function (data_p) {
                ...
                if (data_p[0] === undefined) {
                    ...
                    result_db = "Driver " + drivername + " is already injected!";
                    response.result = result_db;
                    res.send(JSON.stringify(response));
                    logger.warn("[DRIVER] --> " + result_db);
