...
driver_utils = function (session, rest) {
    ...
    rest.put('/v1/drivers/:node', function (req, res) {
        ...
        node_utility.checkNodeAvailable(node, res, function (available){
            ...
            if(available.result == "SUCCESS"){
                ...
                var APIparamsList= {"drivername":drivername, "autostart":autostart};
    ...
    rest.delete('/v1/drivers/:driver/:node', function (req, res) {
    ...
    rest.post('/v1/drivers/:node', function (req, res) {
        ...
        node_utility.checkNodeAvailable(node, res, function (available){
            ...
            if(available.result == "SUCCESS"){
                ...
                var mirror_node = req.body.mirror_node;


                if (driveroperation == "mount"){

                    var APIparamsList= {"drivername":drivername, "remote_driver":remote_driver, "driveroperation":driveroperation}; //, "mirror_node":mirror_node};

                } else if (driveroperation == "unmount"){

                    var APIparamsList= {"drivername":drivername, "driveroperation":driveroperation};
