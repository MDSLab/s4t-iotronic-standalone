...
driver_utils = function (session, rest) {
    ...
    rest.get('/v1/nodes/:node/drivers', function (req, res) {

        logger.debug("[API] - Node drivers list - " + Object.keys( req.route.methods ) + " - " + req.route.path);
        ...
        logger.debug("[DRIVER] - Driver list for the node " + node);
    ...
    rest.put('/v1/nodes/:node/drivers/:driver', function (req, res) {
        ...
        node_utility.checkNodeAvailable(node, res, function (available){
            ...
            if(available.result == "SUCCESS"){
                ...
                var APIparamsList= {"autostart":autostart};
                    ...
                    if(check.result == "ERROR"){
                        ...
                        node_utility.checkRestInputs(req, function (check){
                            ...
                            if(check.result == "ERROR"){
                                ...
                                driver_utils.prototype.injectDriver(node, drivername, autostart, res);
    ...
    rest.delete('/v1/nodes/:node/drivers/:driver', function (req, res) {
        ...
        node_utility.checkNodeAvailable(node, res, function (available){
            ...
            if(available.result == "SUCCESS"){
                ...
                driver_utils.prototype.removeDriver(node, drivername, res);
    ...
    //ACTION driver on node
    //rest.post('/v1/drivers/:node', function (req, res) {
    rest.post('/v1/nodes/:node/drivers/:driver/action', function (req, res) {
        ...
        node_utility.checkNodeAvailable(node, res, function (available){
            ...
            if(available.result == "SUCCESS"){
                ...
                var mirror_node = req.body.mirror_node;  //OPTIONAL
                ...
                if(mirror_node != "" && mirror_node != undefined){

                    logger.info("[API] --> Remote mounting using mirror node "+mirror_node);
                        ...
                        if(check.result == "ERROR"){
                            ...
                            node_utility.checkRestInputs(req, function (check){
                                ...
                                if(check.result == "ERROR"){
                                    ...
                                    driver_utils.prototype.manageDrivers(node, drivername, driveroperation, remote_driver, mirror_node, res);
    ...
    rest.post('/v1/nodes/:node/drivers/read', function (req, res) {
                    ...
                    if(check.result == "ERROR"){
                        ...
                        node_utility.checkRestInputs(req, function (check){
                            ...
                            if(check.result == "ERROR"){
                                ...
                                driver_utils.prototype.readRemoteFile(node, drivername, driver_exp_filename, res);
    ...
    rest.post('/v1/nodes/:node/drivers/write', function (req, res) {
                    ...
                    if(check.result == "ERROR"){
                        ...
                        node_utility.checkRestInputs(req, function (check){
                            ...
                            if(check.result == "ERROR"){
                                ...
                                driver_utils.prototype.writeRemoteFile(node, drivername, driver_exp_filename, filecontent, res);
                                ...
                                function (result) {
                                    ...
                                    db.deleteInjectedDriver(board, driverId, function (data_p) {
                                        if (data_p.result == "ERROR") {
                                            ...
                                            response.message = "Driver " + drivername + " successfully removed from node " + board;
                                            response.result = "SUCCESS";
                                            logger.info("[DRIVER] --> " + response.message);
                                            res.send(JSON.stringify(response));
                                        }
