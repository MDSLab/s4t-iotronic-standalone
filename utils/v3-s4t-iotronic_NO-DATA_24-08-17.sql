...
INSERT INTO `new-s4t-iotronic`.`layouts` (`id_layout`, `model`, `manufacturer`, `image`) VALUES (DEFAULT, NULL, NULL, '');

COMMIT;


-- -----------------------------------------------------
-- Data for table `new-s4t-iotronic`.`projects`
-- -----------------------------------------------------
START TRANSACTION;
USE `new-s4t-iotronic`;
INSERT INTO `new-s4t-iotronic`.`projects` (`uuid`, `name`, `description`) VALUES ('cfbb455e-865e-4dc6-b3e1-93a5d23ad672', 'admin', 'Main project for Admin user.');

COMMIT;


-- -----------------------------------------------------
-- Data for table `new-s4t-iotronic`.`users`
-- -----------------------------------------------------
START TRANSACTION;
USE `new-s4t-iotronic`;
INSERT INTO `new-s4t-iotronic`.`users` (`uuid`, `username`, `password`, `email`, `first_name`, `last_name`, `reg_time`) VALUES ('dd90db22-219a-4eff-a8bc-f51c8b5790da', 'admin', 'admin', 'smartme@unime.it ', NULL, NULL, DEFAULT);

COMMIT;


-- -----------------------------------------------------
-- Data for table `new-s4t-iotronic`.`boards`
-- -----------------------------------------------------
START TRANSACTION;
USE `new-s4t-iotronic`;
INSERT INTO `new-s4t-iotronic`.`boards` (`board_code`, `label`, `session_id`, `status`, `reg_time`, `type`, `description`, `net_enabled`, `projects_id`, `users_id`, `mobile`, `position_refresh_time`) VALUES ('86c057be-1e26-7664-ec02-3235c8c441f6', 'laptop-14', NULL, NULL, NULL, 2, 'LR node example.', false, 'cfbb455e-865e-4dc6-b3e1-93a5d23ad672', 'dd90db22-219a-4eff-a8bc-f51c8b5790da', false, 10);
...
-- -----------------------------------------------------
-- Data for table `new-s4t-iotronic`.`coordinates`
-- -----------------------------------------------------
START TRANSACTION;
USE `new-s4t-iotronic`;
INSERT INTO `new-s4t-iotronic`.`coordinates` (`coordinates_id`, `board_id`, `altitude`, `longitude`, `latitude`, `timestamp`) VALUES (1, '86c057be-1e26-7664-ec02-3235c8c441f6', '0', '0', '0', DEFAULT);
