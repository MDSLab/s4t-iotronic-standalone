...
START TRANSACTION;
USE `s4t-iotronic`;
INSERT INTO `s4t-iotronic`.`layouts` (`id_layout`, `model`, `manufacturer`, `image`) VALUES (1, 'YUN', 'Arduino', 'linino');
INSERT INTO `s4t-iotronic`.`layouts` (`id_layout`, `model`, `manufacturer`, `image`) VALUES (2, 'server', 'standard', '-');
INSERT INTO `s4t-iotronic`.`layouts` (`id_layout`, `model`, `manufacturer`, `image`) VALUES (3, 'Raspberry Pi 3', 'Raspberry', '-');
