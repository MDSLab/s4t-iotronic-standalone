...
START TRANSACTION;
USE `new-s4t-iotronic`;
INSERT INTO `new-s4t-iotronic`.`users` (`uuid`, `username`, `password`, `email`, `first_name`, `last_name`, `latest_update`) VALUES ('dd90db22-219a-4eff-a8bc-f51c8b5790da', 'admin', 'admin', 'smartme@unime.it', NULL, NULL, DEFAULT);
