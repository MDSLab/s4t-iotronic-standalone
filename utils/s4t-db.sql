...
START TRANSACTION;
USE `new-s4t-iotronic`;
INSERT INTO `new-s4t-iotronic`.`users` (`uuid`, `username`, `password`, `email`, `first_name`, `last_name`, `latest_update`) VALUES ('dd90db22-219a-4eff-a8bc-f51c8b5790da', 'admin', 'admin', 'npeditto@unime.it', NULL, NULL, DEFAULT);
...
START TRANSACTION;
USE `new-s4t-iotronic`;
INSERT INTO `new-s4t-iotronic`.`boards` (`board_code`, `label`, `session_id`, `status`, `latest_update`, `type`, `description`, `net_enabled`, `projects_id`, `users_id`, `mobile`, `position_refresh_time`, `notify`, `notify_rate`, `notify_retry`) VALUES ('86c057be-1e26-7664-ec02-3235c8c441f6', 'laptop-14', NULL, NULL, NULL, 2, 'LR node example.', false, 'cfbb455e-865e-4dc6-b3e1-93a5d23ad672', 'dd90db22-219a-4eff-a8bc-f51c8b5790da', false, 60, false, '600', 1);
